...
class tournoi:
        ...
        with open(file_name, 'r') as file:
            ...
            for line in file:
                ...
                if re.match(r"^\d+\.", line):
                    ...
                    description_lines = [
                        line.split(".")[1].strip()]  # conservez uniquement la partie après le numéro et le point
                else:
    ...
    def _creer_appariements(self):
        ...
        print(f"appariements pour la ronde {self._ronde_en_cours(to_return)} : {to_return}")
...
if __name__ == '__main__':
    ...
    # tournoi = tournoi("source_simple.txt")
